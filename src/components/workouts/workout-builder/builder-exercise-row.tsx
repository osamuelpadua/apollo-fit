...
import { updateWorkoutExercise, deleteWorkoutExercise } from "@/features/workouts/actions"
...
export function BuilderExerciseRow({ row, onDelete }: Props) {
  ...
  function saveField(patch: Parameters<typeof updateWorkoutExercise>[1]) {
    startTransition(async () => {
      const result = await updateWorkoutExercise(row.id, patch)
